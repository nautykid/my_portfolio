  ...
  return (
    <div className="home__data">
        ...
        <h3 className="home__subtitle">
            Network Administrator / Surveillance Technician / Access Control Technician / Software Engineer
        </h3>
        <p className="home__description">
        Welcome to my portfolio!
I am Bhuwan Thanet, a Professional Surveillance Technician with extensive experience in the casino industry. I specialize in advanced surveillance systems and robust networking solutions, working closely with Dallmeier for CCTV and holding certification in Gallagher access control systems. My role ensures top-notch security and efficiency in high-stakes environments.
As a Networking Administrator, I excel in managing and optimizing network infrastructures using Cisco and Aruba technologies, delivering seamless and secure network performance.
Beyond surveillance and networking, I am a Freelance Software Engineer. I develop tailored software solutions, create responsive websites, and design intuitive UI/UX interfaces, combining functionality with aesthetics to enhance user experience.
Explore my portfolio to see my work and learn more about my professional journey. Please contact me if you have any questions or wish to discuss potential collaborations.
